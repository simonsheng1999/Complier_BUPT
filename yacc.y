...
%token AND ARRAR PBEGIN BOOLEAN CASE CHAR CONST DIV DO DOWNTO END FOR FUNCTION IF MOD STRING
...
statement
	...
	| FOR IDENTIFIER ASSIGNOP expression DOWNTO expression DO statement 
	{
		p=newNode(-1,"statement",0);
        p.children.push_back($1);
        p.children.push_back($2);
